...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://mockshopapi.lin.com.tw:8880';
    ...
    {
        $report  = 'PHP SDK (Lintrading) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings(): array
    {
        return [
            [
                "url" => "https://mockshopapi.lin.com.tw:8880",
                "description" => "開發環境",
            ],
            [
                "url" => "https://shopapi.lin.com.tw",
                "description" => "生產環境",
            ]
        ];
    }
