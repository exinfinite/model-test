...
class Price implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('discountedPrice', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets originalPrice
     *
     * @param float|null $originalPrice 原價
     *
     * @return $this
     */
    ...
    {
        return $this->container['discountedPrice'];
    }

    /**
     * Sets discountedPrice
     *
     * @param float|null $discountedPrice 折扣價
     *
     * @return $this
     */
    public function setDiscountedPrice(?float $discountedPrice): static
    {
        if (is_null($discountedPrice)) {
            throw new InvalidArgumentException('non-nullable discountedPrice cannot be null');
        }
        $this->container['discountedPrice'] = $discountedPrice;
